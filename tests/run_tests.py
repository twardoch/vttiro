...
class TestRunner:
    ...
    def quick_tests(self) -> int:
        ...
        cmd = [
            "python", "-m", "pytest",
            "-m", "not slow and not api and not network",
            "-n", "auto",
            "--cov=src/vttiro",
            "--cov-report=term-missing",
            "-v",
    ...
    def ci_tests(self) -> int:
        ...
        cmd = [
            ...
            "-m", "not slow and not api",  # Skip slow and API tests in CI
            "tests/"
        ]
...
def main():
    ...
    parser.add_argument(
        "test_type",
        choices=[
            "unit", "integration", "performance", "property", "error",
            "slow", "api", "quick", "full", "regression", "security",
            "typecheck", "lint", "precommit", "ci"
        ],
