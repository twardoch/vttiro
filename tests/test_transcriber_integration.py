...
class TestTranscriberIntegration:
    ...
    def test_transcriber_initialization_failure(self):
        ...
        with patch("vttiro.core.config.VttiroConfig.load_default", side_effect=Exception("Config load failed")):
    ...
    def test_engine_initialization_with_all_failures(self, mock_config):
        ...
        with (
            patch("vttiro.core.transcriber.VideoProcessor"),
    ...
    async def test_transcribe_processing_error(self, transcriber):
        ...
        transcriber.processing_resilience.execute = AsyncMock(side_effect=Exception("Video processing failed"))
